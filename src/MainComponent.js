...
import { addTodo, clearAllTasks, toggleToDo , deleteAllTasks , removeSingleTask} from './redux/ActionCreators'
      ...
      <div className='App'>
        ...
        <ul>
          ...
          <li key={'unique key'}>
            ...
            {todo.activity}<button onClick={() => this.props.removeSingleTask(todo.id)}>Remove</button>
          </li>)}
